...
var botCmd = exports.botCmd = function botCmd(chatId, command) {var pars = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    return {
        type: BOT_CMD,
        chatId: chatId,
        command: command,
...
var fileSave = exports.fileSave = function fileSave(file, data, type) {
    return function (dispatch) {
        ...
        then(function (data) {return dispatch(fileSaveDone(file));}).
        catch(function (err) {
            //TODO: обработка ошибки
        });
    };
...
var jsonSave = exports.jsonSave = function jsonSave(file, data) {
    return function (dispatch) {
        ...
        then(function (data) {return dispatch(jsonSaveDone(file));}).
        catch(function (err) {
            //TODO: обработка ошибки
        });
    };
...
var userAdd = exports.userAdd = function userAdd(_ref) {var id = _ref.id,firstName = _ref.firstName,lastName = _ref.lastName,username = _ref.username;
    return {
        type: USER_ADD,
        id: id,
        firstName: firstName,
